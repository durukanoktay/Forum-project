...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="{{asset('assets')}}/admin/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
...
<script src="{{asset('assets')}}/admin/js/passwd.js"></script>
</body>
</html>
